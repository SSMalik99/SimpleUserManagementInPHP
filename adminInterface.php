<?php
    ...
    if($_SESSION['userRole']=="admin"){
        ...
        echo '<script>alert("You are not logged in as end User! go back and logged in")</script>';
...
<body>
    ...
    <div class="container">
        ...
        <button name="showAllMember" class="btn bg-dark">Show all Members</button>
        </form>
        <div>
        ...
        <div>
            <button name="addUserModal1" data-toggle="modal" data-target="#addUserModal" class="btn btn-secondary">Add New User</button>
